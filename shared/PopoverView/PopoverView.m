...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    [self setupBackgroundInView:view];
    ...
    [UIView animateWithDuration:0.2f delay:0.f options:UIViewAnimationOptionCurveEaseInOut animations:^{
        self.alpha = 1.f;
        self.transform = CGAffineTransformMakeScale(1.01f, 1.01f); // was: 1.05f
...
- (void) setupBackgroundInView:(UIView *)inParentView
{
	UIWindow* keyWindow = [[UIApplication sharedApplication] keyWindow];
	UIViewController* root_controller = [keyWindow rootViewController];
	UIView* owner = root_controller.view;
	UIViewController* presented_controller = root_controller.presentedViewController;
	if (presented_controller) {
		owner = presented_controller.view;
	}
